<div class="flex flex-col h-full bg-sidebar text-sidebar-foreground">
    ...
    <nav class="flex-1 px-4 py-4 space-y-6 overflow-y-auto overflow-x-hidden">
        ...
        <div class="space-y-1">
            ...
            <a href="/" :class="!sidebarOpen && 'justify-center'"
                ...
                <span x-show="sidebarOpen" x-cloak class="whitespace-nowrap">Reports</span>
            </a>
        </div>
        @else
        <!-- Kasir Menu -->
        <div class="space-y-1">
            ...
            <a href="{{ route('kasir.dashboard') }}" :class="!sidebarOpen && 'justify-center'"
                ...
                <span x-show="sidebarOpen" x-cloak class="whitespace-nowrap">Incoming Orders</span>
            </a>
        </div>
        @endif
        @endauth
    ...
    <div class="p-4 border-t border-sidebar-border flex items-center"
        ...
        <div class="flex items-center gap-3 overflow-hidden">
            ...
            <div class="flex flex-col truncate" x-show="sidebarOpen" x-cloak>
